...
<form class="cash-form" action="pro/cash" method="post">
    <div class="cash-container">
        <div class="cash-item">
            <input type="radio" name="pro_cash" value="1,200" checked> 1,200 C : 990 円
        </div>
        <div class="cash-item">
            <input type="radio" name="pro_cash" value="2,540"> 3,300 C : 2,540 円
        </div>
        <div class="cash-item">
            <input type="radio" name="pro_cash" value="5,000"> 8,500 C : 5,000 円
        </div>
