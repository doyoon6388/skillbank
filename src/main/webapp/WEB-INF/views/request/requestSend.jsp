...
<div class="requestSendWrapper">
    ...
    <textarea name="r_comment">
            ...
            <div>
                ...
                <br>
                <!-- 변경하기 버튼: 파일 선택 창 호출 -->
                <button id="sendR" data-request-no="${proRequest.request_no}" data-user="${proRequest.r_user_id}"
                        data-user-nickname="${sessionScope.user.user_nickname}" data-pro="${sessionScope.proSession.pro_pk}"
                        data-pro-name="${sessionScope.user.user_nickname}"> 견적 제출하기</button>
            </div>
        </div>
    </div>
</div>
