...
<head>
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBI9oa4kZP2eh0RnVd3cylq3sUvY3Bipcc&callback=initMap"></script>
    <style>
        .air img {
            width: 100px;
            height: 100px;
...
<div class="findpro-lower-wrapper">
    ...
    <div class="special-request-btn-container">
        <button id="special-request-btn" onclick="openModal()">개별 견적 요청하기</button>
    </div>
</div>
