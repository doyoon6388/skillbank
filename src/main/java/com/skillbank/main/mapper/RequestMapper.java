...
public interface RequestMapper {
    ...
    @Select("select r.request_no , r.request_type, u.user_profile_img, u.user_nickname, r.request1, r.request2,r.request3 ,r.request4, r.request5, r.request6, r.request7, r.request8, r.request9, r.request10, r.request11, r.request12, r.request13, r.request14 from request r join user_account u on r.r_user_id = u.user_pk where r.request_type = #{pro_category}")
